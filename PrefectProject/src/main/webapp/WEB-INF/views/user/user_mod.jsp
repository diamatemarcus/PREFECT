	     ...
	     <div>
	       <form action="#" name="userRegFrm">
               ...
               <div class="mb-3">
                   ...
                   <input type="text"  class="form-control numOnly" name="tel" id="tel" placeholder="전화번호 수정" 
                   value="${outVO.tel }"
                   size="20"  maxlength="11">
               </div>    
               <div class="mb-3">
                   <label for="recommend" class="form-label">학력</label>
                   <input type="text" class="form-control"  name="recommend" id="recommend" placeholder="학력 수정" 
