            ...
            <form action="#" name="userRegFrm">
                ...
                <div>
                    <label for="password" class="form-label">비밀번호</label> <input
                        ...
                        name="password" id="password" value="${outVO != null ? outVO.password : userSession.password}" size="20"
                        maxlength="30">
                </div>
                ...
                <div class="row">
                    <div class="col-md-2 mb-3">
                        <input type="button" value="활동정지" class="btn btn-primary" id="doPauseUser">
                    </div>
                    <div class="col-md-3 mb-3">
                        <input type="button" value="정지해제" class="btn btn-primary" id="doResumeUser">
                    </div>
                </div>
