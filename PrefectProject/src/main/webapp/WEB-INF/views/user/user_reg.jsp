...
<link rel="stylesheet"
	href="${CP}/resources/template/login/assets/css/bootstrap.min.css"
	type="text/css">
<!-- FontAwesome CSS -->
<link rel="stylesheet"
	href="${CP}/resources/template/login/assets/css/all.min.css"
	type="text/css">
<link rel="stylesheet"
	href="${CP}/resources/template/login/assets/css/uf-style.css"
	type="text/css">
		...
		<div class="text-left">
			<a href="/ehr/index.jsp" class="navbar-brand">
				<div class="arms-container d-flex align-items-center">
					<img src="${CP}/resources/template/img/acorn.png" alt="ARMS Logo"
						width="150" height="75">
				</div>
		...
		<form class="mt-4">
			...
			<div class="mt-4 text-center">
				<span class="text-white">이미 회원이신가요?</span> <a
					href="/ehr/login/loginView.do">로그인</a>
			</div>
		</form>
	</div>
									...
									.click(
											function() {
												...
												$
														.ajax({
															type : 'get',
															url : '/ehr/user/mailCheck.do?email='
