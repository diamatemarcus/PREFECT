...
<body>
	...
	<div class="container" style="margin-top: 70px;">
	    ...
	    -->
				...
				<form action="#" name="regFrm" id="regFrm">
					...
					<div class="mb-3">
						...
						<textarea rows="7" class="form-control readonly-input"
							id="contents" name="contents" readonly="readonly">${vo.contents}</textarea>
					</div>
					...
					<div class="mb-3 row" style="display: none;">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control readonly-input" id="seq"
								name="seq" maxlength="100" value="${vo.seq }" readonly>
						</div>
					</div>
					...
					<div class="mb-3 row" style="display: none;">
						...
						<div class="col-sm-10">
							<select class="form-select" aria-label="Default select example"
								id="div" name="div" disabled="disabled">
								<c:forEach var="codeVO" items="${divCode}">
									<option value="<c:out value='${codeVO.detCode}'/>"
										<c:if test="${codeVO.detCode == vo.getDiv() }">selected</c:if>><c:out
											value="${codeVO.detName}" /></option>
								</c:forEach>
					...
					<div class="mb-3 row" style="display: none;">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control readonly-input" id="modId"
								name="modId" value="${vo.modId }" readonly="readonly">
						</div>
					</div>
					<!-- // --------------------------------------------------------------->
							...
							<tbody>
								<c:if test="${not empty fileList}">
									<c:forEach var="file" items="${fileList}" varStatus="status">
										<tr data-org-file-name="${file.orgFileName}"
											data-save-file-name="${file.saveFileName}"
											data-save-path="${file.savePath}">
				...
				<!-- 파일 다운로드 -->
				<form action="${CP}/file/download.do" method="POST"
					name="fileDownloadForm">
					<input type="hidden" name="orgFileName" id="orgFileName"> <input
			...
			<div id="commentsSection" class="comments-container">
				...
				<div class="reply-input-area">
					<div class="mb-3">
						<textarea rows="3" class="form-control" id="replyContents"
